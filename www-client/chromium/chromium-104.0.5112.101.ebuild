...
src_prepare() {
	...
	if use riscv; then
		PATCHES+=(
			"${FILESDIR}/riscv/riscv-angle.patch"
			"${FILESDIR}/riscv/riscv-base.patch"
			"${FILESDIR}/riscv/riscv-breakpad.patch"
			"${FILESDIR}/riscv/riscv-crashpad.patch"
			"${FILESDIR}/riscv/riscv-dav1d.patch"
			"${FILESDIR}/riscv/riscv-sandbox.patch"
			"${FILESDIR}/riscv/riscv-v8.patch"
			"${FILESDIR}/riscv/riscv.patch"
			"${FILESDIR}/riscv/riscv-ffmpeg-config.patch"
		)
	fi
